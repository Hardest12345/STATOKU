...
<head>
  ...
  <title>Tambah Flipbook - Admin</title>
  ...
  <style>
    ...
    .error-box { background: #ffeaea; border: 1px solid #ffbcbc; color: #a33; padding: 1rem; border-radius: 0.5rem; margin-bottom: 1rem; }
  </style>
</head>
<body>
      ...
      <div class="form-card">
        ...
        <form method="post" enctype="multipart/form-data">
          <div class="form-group">
            ...
            <input type="text" name="title" placeholder="Masukkan judul flipbook..." required>
          </div>

          <div class="form-group">
            <label>Deskripsi</label>
            <textarea name="description" placeholder="Tuliskan deskripsi singkat tentang flipbook..."></textarea>
          </div>

          <div class="form-group">
            <label>Cover (Upload Gambar)</label>
            <input type="file" name="file" accept="image/*" required>
          </div>

          <div class="form-group">
            <label>Embed URL (iframe source)</label>
            <input type="text" name="embed_url" placeholder="Masukkan URL iframe dari flipbook" required>
          </div>

          <div class="form-group">
            <label>Kategori</label>
            <input type="text" name="category" placeholder="Contoh: Dasar / Lanjutan">
          </div>
          ...
          <div style="text-align: right;">
            <button type="submit" class="btn-primary">➕ Tambah Flipbook</button>
          </div>
        </form>
      </div>
    </main>
